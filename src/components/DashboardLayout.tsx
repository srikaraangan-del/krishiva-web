...
const sidebarItems = [
  ...
  { icon: Users, label: 'Labor', href: '/dashboard/labor' },
  { icon: Settings, label: 'Machinery', href: '/dashboard/machinery' },
  { icon: Wheat, label: 'Drones', href: '/dashboard/drones' },
  { icon: ShoppingCart, label: 'Produce', href: '/dashboard/produce' },
  { icon: Sprout, label: 'Inputs', href: '/dashboard/inputs' },
  { icon: Stethoscope, label: 'Crop Doctor', href: '/dashboard/crop-doctor' },
  { icon: IndianRupee, label: 'Finance', href: '/dashboard/finance' },
